...
export function About() {
    return (
        <main className="about main-layout">
            <h2>Who are we?</h2>
            <p>
                Mister-Toy®: Where kids are a big deal!™
            </p>
            <p>
                Mister Toy is the beloved brand of kids all over the world…and we know how to have lotsa fun! You can explore awesome DIY play activities, toy reviews, printable fun and, of course, SO many toys! The hottest, the gotta-have-'ems, the new favorite besties and more.
            </p>
